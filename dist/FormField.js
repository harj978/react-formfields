...
const TextField = propsIn => {
  ...
  const dummyRef = (0, _react.useRef)(null);
  ...
  if (enableField) {
    ...
    if (type === "text") {
      outElement = /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement("input", {
        type: type,
        name: name,
        ref: ref,
        value: value,
      ...
      outElement = /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement(_reactSelect.default, {
        name: name,
        ref: ref,
        options: ddData,
      ...
      outElement = /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement("select", {
        name: name,
        ref: ref,
        value: value,
        onChange: event => handleEditFormChange(event),
        ...
        disabled: false,
        readOnly: readOnly
      }, ddData.map(ddDataElements => /*#__PURE__*/_react.default.createElement("option", {
        value: ddDataElements.value
      }, ddDataElements.label))), /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("span", {
        id: errorID,
        className: "text-error text-danger"
      }, errorMessage)));
    } else if (type === "radio") {
      ...
      outElement = /*#__PURE__*/_react.default.createElement("label", {
        className: checkboxLabelClass
      }, checkboxLabelLEFT, /*#__PURE__*/_react.default.createElement("input", {
        name: name,
        ref: ref,
        type: type,
      ...
      outElement = /*#__PURE__*/_react.default.createElement("button", {
        ref: ref,
        name: name,
        style: style,
        title: value,
      ...
      }, useIcon ? /*#__PURE__*/_react.default.createElement(_reactFontawesome.FontAwesomeIcon, {
        icon: [iconFasFar, icon],
        style: {
          color: iconColour
        },
        size: iconSize
      ...
      outElement = /*#__PURE__*/_react.default.createElement("div", {
